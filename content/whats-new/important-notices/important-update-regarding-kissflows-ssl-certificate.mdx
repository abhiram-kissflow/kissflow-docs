...
1. Download the [Sectigo Public Server Authentication Root R46 certificate](https://crt.sh/?d=1199354).
2. Install it into your system's trusted root store:
   ...
   - **Java** — Copy the certificate to `$JAVA_HOME/lib/security/cacerts` and run:
